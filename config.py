...
class Config(object):
    ...
    OWNER_ID = int(getenv("OWNER_ID", "6184402222"))  # sᴛᴀʀᴛ @Exon_Robot ᴛʏᴘᴇ /id
    OWNER_USERNAME = getenv("OWNER_USERNAME", "Sreenathbhasi_official")
    SUPPORT_CHAT = getenv("SUPPORT_CHAT", "Sreenathbhasi_official")
